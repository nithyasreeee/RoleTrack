            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade" onClick={closeModal}>
                  ...
                  >
                    ...
                    <div className="text-center mb-6">
                      ...
                      <h3 className="text-2xl font-bold text-gray-900 dark:text-white capitalize">{role} Authentication</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Please enter your credentials to access your account</p>
                    </div>
